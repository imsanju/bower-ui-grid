                        ...
                        return {
                            ...
                            post: function(a, c, e, g) {
                                ...
                                a.downFn = function(e) {
                                    ...
                                    })["catch"](angular.noop), k.fireEvent(f.events.COLUMN_HEADER_CLICK, {
                                        event: e,
            ...
            var d = {
                ...
                setMenuItemTitle: function(b, c, d) {
                    ...
                    "string" == typeof e ? b.title = e : e.then ? (b.title = "", e.then(function(a) {
                        ...
                        b.title = a
                    })["catch"](angular.noop)) : (a.logError("Expected gridMenuTitleFilter to return a string or a promise, it has returned neither, bad config"), b.title = "badconfig")
                },
        ...
        angular.module("ui.grid").directive("uiGridMenu", ["$compile", "$timeout", "$window", "$document", "gridUtil", "uiGridConstants", "i18nService", function(a, b, c, d, e, f, g) {
            var h = {
                ...
                link: function(d, h, i, j) {
                    if (d.dynamicStyles = "", j && j.grid && j.grid.options && j.grid.options.gridMenuTemplate) {
                    ...
                    var l = function(a) {
                        ...
                        d.dynamicStyles = [".grid" + j.grid.id + " .ui-grid-menu-mid {", "max-height: " + b + "px;", "}"].join(" ")
                    };
                    j && (l(j.grid.gridHeight), j.grid.api.core.on.gridDimensionChanged(d, function(a, b, c, d) {
                        l(c)
                    })), d.i18n = {
                        close: g.getSafeText("columnMenu.close")
                    }, d.showMenu = function(a, c) {
                        d.shown ? d.shownMid || (d.shownMid = !0, d.$emit("menu-shown")) : (d.shown = !0, b(function() {
                            d.shownMid = !0, d.$emit("menu-shown")
                        }));
                        var f = "click";
                        c && c.originalEvent && c.originalEvent.type && "touchstart" === c.originalEvent.type && (f = c.originalEvent.type), angular.element(document).off("click touchstart", m), h.off("keyup", n), h.off("keydown", o), b(function() {
                            angular.element(document).on(f, m), h.on("keyup", n), h.on("keydown", o)
                        }), e.focus.bySelector(h, "button[type=button]", !0)
                    }, d.hideMenu = function(a) {
                        d.shown && (d.shownMid = !1, b(function() {
                            d.shownMid || (d.shown = !1, d.$emit("menu-hidden"))
                        }, 200)), angular.element(document).off("click touchstart", m), h.off("keyup", n), h.off("keydown", o)
                    ...
                    var m = function() {
                        ...
                        o = function(a) {
                            ...
                            if (9 === a.keyCode) {
                                var c, d, e = h[0].querySelectorAll("button:not(.ng-hide)");
                                e.length > 0 && (c = e[0], d = e[e.length - 1], a.target !== d || a.shiftKey ? a.target === c && a.shiftKey && b(d) : b(c))
                            }
                        };
                    ("undefined" == typeof d.autoHide || void 0 === d.autoHide) && (d.autoHide = !0), d.autoHide && angular.element(c).on("resize", m), d.$on("$destroy", function() {
                        angular.element(c).off("resize", m), angular.element(document).off("click touchstart", m), h.off("keyup", n), h.off("keydown", o)
                    }), j && d.$on("$destroy", j.grid.api.core.on.scrollBegin(d, m)), d.$on("$destroy", d.$on(f.events.ITEM_DRAGGING, m))
                }
            };
            return h
                ...
                compile: function() {
                    return {
                        ...
                        post: function(b, d, e, f) {
                            ...
                            }, b.itemAction = function(c, d) {
                                if (c.stopPropagation(), "function" == typeof b.action) {
                                    var e = {};
                                    b.context && (e.context = b.context), "undefined" != typeof g && g && (e.grid = g.grid), b.action.call(e, c, d), b.leaveOpen ? a.focus.bySelector(angular.element(c.target.parentElement), "button[type=button]", !0) : b.$emit("hide-menu")
                                }
                            }, b.i18n = c.get()
                        }
                    }
        ...
        angular.module("ui.grid").directive("uiGridViewport", ["gridUtil", "ScrollEvent", "uiGridConstants", "$log", function(a, b, c, d) {
            return {
                ...
                link: function(c, d, e, f) {
                    ...
                    c.$parent.bindScrollVertical && p.addVerticalScrollSync(c.$parent.containerId, h), c.$parent.bindScrollHorizontal && (p.addHorizontalScrollSync(c.$parent.containerId, i), p.addHorizontalScrollSync(c.$parent.containerId + "header", j), p.addHorizontalScrollSync(c.$parent.containerId + "footer", k)), c.$on("$destroy", function() {
                        d.off()
                    })
                },
                controller: ["$scope", function(a) {
                ...
                compile: function() {
                    return {
                        post: function(d, e, f, g) {
                            function h() {
                                e[0].offsetWidth <= 0 && o > p ? (setTimeout(h, n), p++) : d.$applyAsync(j)
                            }

                            function i() {
                                var b, c;
                                angular.element(a).on("resize", l), e.on("$destroy", function() {
                                    angular.element(a).off("resize", l), b(), c()
                                }), b = d.$watch(function() {
                                    return m.hasLeftContainer()
                                }, function(a, b) {
                                    a !== b && m.refreshCanvas(!0)
                                }), c = d.$watch(function() {
                                    return m.hasRightContainer()
                                }, function(a, b) {
                                    a !== b && m.refreshCanvas(!0)
                                })
                            }
                            ...
                            function j() {
                                m.gridWidth = d.gridWidth = b.elementWidth(e), m.canvasWidth = g.grid.gridWidth, m.gridHeight = d.gridHeight = b.elementHeight(e), m.gridHeight <= m.options.rowHeight && m.options.enableMinHeightCheck && k(), m.refreshCanvas(!0)
                            }

                            function k() {
                                var a = m.options.minRowsToShow * m.options.rowHeight,
                                    f = m.options.showHeader ? m.options.headerRowHeight : 0,
                                    g = m.calcFooterHeight(),
                                    h = 0;
                                m.options.enableHorizontalScrollbar === c.scrollbars.ALWAYS && (h = b.getScrollbarWidth());
                                var i = 0;
                                if (angular.forEach(m.options.columnDefs, function(a) {
                                        a.hasOwnProperty("filter") ? 1 > i && (i = 1) : a.hasOwnProperty("filters") && i < a.filters.length && (i = a.filters.length)
                                    }), m.options.enableFiltering && !i) {
                                    var j = m.options.columnDefs.length && m.options.columnDefs.every(function(a) {
                                ...
                                var k = i * f,
                                    l = f + a + g + h + k;
                                e.css("height", l + "px"), m.gridHeight = d.gridHeight = b.elementHeight(e)
                            }

                            function l() {
                                m.gridWidth = d.gridWidth = b.elementWidth(e), m.gridHeight = d.gridHeight = b.elementHeight(e), m.refreshCanvas(!0)
                            }
                            var m = g.grid;
                            g.scrollbars = [], m.element = e;
                            var n = 100,
                                o = 20,
                                p = 0;
                            i(), j(), m.renderingComplete(), h()
                        }
                    }
                }
            }
        }
        angular.module("ui.grid").controller("uiGridController", ["$scope", "$element", "$attrs", "gridUtil", "$q", "uiGridConstants", "gridClassFactory", "$parse", "$compile", function(a, b, c, d, e, f, g, h, i) {
            function j(a) {
                return a ? a.length : 0
            }

            function k(b, c) {
                b && b !== c && (m.grid.options.columnDefs = a.uiGrid.columnDefs, m.grid.callDataChangeCallbacks(f.dataChange.COLUMN, {
                    orderByColumnDefs: !0,
            ...
            function l(b) {
                var d = [];
                if (b = angular.isString(a.uiGrid.data) ? m.grid.appScope[a.uiGrid.data] : a.uiGrid.data, o = b, b) {
                    var g = m.grid.columns.length > (m.grid.rowHeaderColumns ? m.grid.rowHeaderColumns.length : 0);
                    !g && !c.uiGridColumns && 0 === m.grid.options.columnDefs.length && b.length > 0 && m.grid.buildColumnDefsFromData(b), !g && (m.grid.options.columnDefs.length > 0 || b.length > 0) && d.push(m.grid.buildColumns().then(function() {
                        m.grid.preCompileCellTemplates()
                    })["catch"](angular.noop)), e.all(d).then(function() {
                        m.grid.modifyRows(o).then(function() {
                            m.grid.redrawInPlace(!0), a.$evalAsync(function() {
                                m.grid.refreshCanvas(!0), m.grid.callDataChangeCallbacks(f.dataChange.ROW)
                            })
                        })["catch"](angular.noop)
                    })["catch"](angular.noop)
                }
            ...
            var m = this,
                n = [];
            m.grid = g.createGrid(a.uiGrid), m.grid.appScope = m.grid.appScope || a.$parent, b.addClass("grid" + m.grid.id), m.grid.rtl = "rtl" === d.getStyles(b[0]).direction, a.grid = m.grid, c.uiGridColumns && n.push(c.$observe("uiGridColumns", function(a) {
                m.grid.options.columnDefs = angular.isString(a) ? angular.fromJson(a) : a, m.grid.buildColumns().then(function() {
                    m.grid.preCompileCellTemplates(), m.grid.refreshCanvas(!0)
                })["catch"](angular.noop)
            })), m.grid.options.fastWatch ? (m.uiGrid = a.uiGrid, angular.isString(a.uiGrid.data) ? (n.push(a.$parent.$watch(a.uiGrid.data, l)), n.push(a.$parent.$watch(function() {
                return m.grid.appScope[a.uiGrid.data] ? m.grid.appScope[a.uiGrid.data].length : void 0
            }, l))) : (n.push(a.$parent.$watch(function() {
                return a.uiGrid.data
            }, l)), n.push(a.$parent.$watch(function() {
                return j(a.uiGrid.data)
            }, function() {
                l(a.uiGrid.data)
            }))), n.push(a.$parent.$watch(function() {
                return a.uiGrid.columnDefs
            }, k)), n.push(a.$parent.$watch(function() {
                return j(a.uiGrid.columnDefs)
            }, function() {
                k(a.uiGrid.columnDefs)
            }))) : (angular.isString(a.uiGrid.data) ? n.push(a.$parent.$watchCollection(a.uiGrid.data, l)) : n.push(a.$parent.$watchCollection(function() {
                return a.uiGrid.data
            }, l)), n.push(a.$parent.$watchCollection(function() {
                return a.uiGrid.columnDefs
            }, k)));
            var o, p = a.$watch(function() {
                return m.grid.styleComputations
            }, function() {
                m.grid.refreshCanvas(!0)
            });
            a.$on("$destroy", function() {
                n.forEach(function(a) {
                    a()
                }), p()
            }), m.fireEvent = function(b, c) {
                c = c || {}, angular.isUndefined(c.grid) && (c.grid = m.grid), a.$broadcast(b, c)
            }, m.innerCompile = function(b) {
                i(b)(a)
            }
        }]), angular.module("ui.grid").directive("uiGrid", a), a.$inject = ["$window", "gridUtil", "uiGridConstants"]
    }(),
    function() {
        "use strict";
    ...
    function() {
        angular.module("ui.grid").factory("Grid", ["$q", "$compile", "$parse", "gridUtil", "uiGridConstants", "GridOptions", "GridColumn", "GridRow", "GridApi", "rowSorter", "rowSearcher", "GridRenderContainer", "$timeout", "ScrollEvent", function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            ...
            p.prototype.calcFooterHeight = function() {
                ...
                angular.forEach(this.dataChangeCallbacks, function(c, d) {
                    (-1 !== c.types.indexOf(e.dataChange.ALL) || -1 !== c.types.indexOf(a) || a === e.dataChange.ALL) && (c._this ? c.callback.apply(c._this, this, b) : c.callback(this, b))
                }, this)
            ...
            }, p.prototype.columnRefreshCallback = function(a, b) {
                a.buildColumns(b), a.queueGridRefresh()
            ...
            }, p.prototype.addRowHeaderColumn = function(a, b, c) {
                var e = this;
                void 0 === b && (b = 0);
                var f = new g(a, d.nextUid(), e);
                f.isRowHeader = !0, e.isRTL() ? (e.createRightContainer(), f.renderContainer = "right") : (e.createLeftContainer(), f.renderContainer = "left"), e.columnBuilders[0](a, f, e.options).then(function() {
                    f.enableFiltering = !1, f.enableSorting = !1, f.enableHiding = !1, f.headerPriority = b, e.rowHeaderColumns.push(f), e.rowHeaderColumns = e.rowHeaderColumns.sort(function(a, b) {
                        return a.headerPriority - b.headerPriority
                    }), c || e.buildColumns().then(function() {
                ...
                return a.all(h).then(function() {
                    f.rows.length > 0 && f.assignTypes(), c.preCompileCellTemplates && f.preCompileCellTemplates()
                })["catch"](angular.noop)
                ...
                c.rowHashMap = c.createRowHashMap(), c.rows.length = 0, b.forEach(function(a, b) {
                    var f, g;
                    g = c.options.enableRowHashing ? e.get(a) : c.getRow(a, d), g && (f = g, f.entity = a), f || (f = c.processRowBuilders(new h(a, b, c))), c.rows.push(f), c.rowHashMap.put(a, f)
                }), c.assignTypes();
                ...
                })["catch"](angular.noop), a.refreshCanceller
                ...
                })["catch"](angular.noop), a.gridRefreshCanceller
                ...
                if (!b.cellDisplayGetterCache) {
                    ...
                    "undefined" != typeof a.entity["$$" + b.uid] ? b.cellDisplayGetterCache = c(a.entity["$$" + b.uid].rendered + d) : this.options.flatEntityAccess && "undefined" != typeof b.field ? b.cellDisplayGetterCache = c("entity." + b.field + d) : b.cellDisplayGetterCache = c(a.getEntityQualifiedColField(b) + d)
                }
            ...
            return p.prototype.renderingComplete = function() {
                ...
                return a.all([d, e]).then(function() {
                    c.refreshCanvas(!0), c.redrawInPlace(b)
                })["catch"](angular.noop)
                ...
                return b && c.buildStyles(), m(f.length > 0 ? function() {
                    var a, g, h = !1,
                        i = 0,
                        j = 0,
                        k = function(a, b) {
        ...
        f.service("gridUtil", ["$log", "$window", "$document", "$http", "$templateCache", "$timeout", "$interval", "$injector", "$q", "$interpolate", "uiGridConstants", function(f, g, l, m, n, o, p, q, r, s, t) {
            ...
            var x = {
                ...
                getTemplate: function(a) {
                    ...
                    if (angular.isFunction(a.then)) return a.then(x.postProcessTemplate)["catch"](angular.noop);
                    try {
                        if (angular.element(a).length > 0) return r.when(a).then(x.postProcessTemplate)["catch"](angular.noop)
                    } catch (b) {}
                    ...
                    }).then(x.postProcessTemplate)["catch"](angular.noop)
                },
            ...
            return x.on.mousewheel = function(a, b) {
                if (a && b) {
                    ...
                    c.on("$destroy", function() {
                        for (var a = A.length; a;) c.off(A[--a], f[b])
                    })
                }
                ...
                compile: function() {
                    return {
                        ...
                        post: function(a, f, g, h) {
                            var i, j, k;
                            h[0] && (i = h[0]), h[1] && (j = h[1]),
                                h[2] && (k = h[2]), a.$on(c.events.BEGIN_CELL_EDIT, function(b, c) {
                                    if (d(function() {
                                    ...
                                    f.on("mousedown", function(b) {
                                        "checkbox" === f[0].type && (f.off("blur", a.stopEdit), d(function() {
                                            f[0].focus(), f.on("blur", a.stopEdit)
                                        }))
                    ...
                    return {
                        ...
                        post: function(b, d, e, f) {
                            ...
                            d[0].addEventListener("change", i, !1), b.$on(c.events.BEGIN_CELL_EDIT, function() {
                                ...
                                d.off(), d[0].removeEventListener("change", i, !1)
                            })
                        }
                    }
                }
            ...
            var g = {
                ...
                addToMenu: function(a) {
                    a.api.core.addToGridMenu(a, [{
                        ...
                        action: function(c) {
                            a.api.exporter.csvExport(b.ALL, b.ALL)
                        },
                        shown: function() {
                            return a.options.exporterMenuCsv && a.options.exporterMenuAllData
                        },
                        order: a.options.exporterMenuItemOrder
                    }, {
                        title: f.getSafeText("gridMenu.exporterVisibleAsCsv"),
                        action: function(c) {
                            a.api.exporter.csvExport(b.VISIBLE, b.VISIBLE)
                        },
                        shown: function() {
                            return a.options.exporterMenuCsv && a.options.exporterMenuVisibleData
                        },
                        order: a.options.exporterMenuItemOrder + 1
                    }, {
                        title: f.getSafeText("gridMenu.exporterSelectedAsCsv"),
                        action: function(c) {
                            a.api.exporter.csvExport(b.SELECTED, b.VISIBLE)
                        },
                        shown: function() {
                            return a.options.exporterMenuCsv && a.options.exporterMenuSelectedData && a.api.selection && a.api.selection.getSelectedRows().length > 0
                        },
                        order: a.options.exporterMenuItemOrder + 2
                    }, {
                        title: f.getSafeText("gridMenu.exporterAllAsPdf"),
                        action: function(c) {
                            a.api.exporter.pdfExport(b.ALL, b.ALL)
                        },
                        shown: function() {
                            return a.options.exporterMenuPdf && a.options.exporterMenuAllData
                        },
                        order: a.options.exporterMenuItemOrder + 3
                    }, {
                        title: f.getSafeText("gridMenu.exporterVisibleAsPdf"),
                        action: function(c) {
                            a.api.exporter.pdfExport(b.VISIBLE, b.VISIBLE)
                        },
                        shown: function() {
                            return a.options.exporterMenuPdf && a.options.exporterMenuVisibleData
                        },
                        order: a.options.exporterMenuItemOrder + 4
                    }, {
                        title: f.getSafeText("gridMenu.exporterSelectedAsPdf"),
                        action: function(c) {
                            a.api.exporter.pdfExport(b.SELECTED, b.VISIBLE)
                        },
                        shown: function() {
                            return a.options.exporterMenuPdf && a.options.exporterMenuSelectedData && a.api.selection && a.api.selection.getSelectedRows().length > 0
                        },
                ...
                formatFieldAsCsv: function(a) {
                    return null == a.value ? "" : "object" == typeof a.value ? a.value.text :"number" == typeof a.value ? a.value : "boolean" == typeof a.value ? a.value ? "TRUE" : "FALSE" : "string" == typeof a.value ? '"' + a.value.replace(/"/g, '""') + '"' : JSON.stringify(a.value)
                },
                isIE: function() {
                ...
                formatFieldAsPdfString: function(a) {
                    var b;
                    return b = null == a.value ? "" : "number" == typeof a.value ? a.value.toString() : "object" == typeof a.value ? a.value : "boolean" == typeof a.value ? a.value ? "TRUE" : "FALSE" : "string" == typeof a.value ? a.value.replace(/"/g, '""') : JSON.stringify(a.value).replace(/^"/, "").replace(/"$/, ""), a.alignment && "string" == typeof a.alignment && (b = {
                        text: b,
            ...
            var j = {
                ...
                insertGroupHeader: function(a, b, c, d, g) {
                    ...
                    for (m && m[l(i)] ? (o = m[l(i)].row, o.entity = {}) : (o = new e({}, null, a), f.rowTemplateAssigner.call(a, o)), o.entity["$$" + d[g].col.uid] = {
                            groupVal: k
                        }, o.treeLevel = g, o.groupHeader = !0, o.internalRow = !0,
                        o.enableCellEdit = !1, o.enableSelection = a.options.enableGroupHeaderSelection, d[g].initialised = !0, d[g].currentValue = i, d[g].currentRow = o, j.finaliseProcessingState(d, g + 1), b.splice(c, 0, o), m = a.grouping.groupingHeaderCache, n = 0; g > n; n++) m = m[l(d[n].currentValue)].children;
                    m[l(i)] = {
                        row: o,
                        children: {}
                    }
            ...
            var b = {
                initializeGrid: function(a) {
                        ...
                        methods: {
                            pagination: {
                                ...
                                getLastRowIndex: function() {
                                    return a.options.useCustomPagination ? c.methods.pagination.getFirstRowIndex() + a.options.paginationPageSizes[a.options.paginationCurrentPage - 1] - 1 : Math.min(a.options.paginationCurrentPage * a.options.paginationPageSize, a.options.totalItems) - 1
                                },
                    ...
                    var d = function(b) {
                        ...
                        return g > f.length && (e = a.options.paginationCurrentPage = 1, g = (e - 1) * d), f.slice(g, h + 1)
                    };
            ...
            var f = {
                initializeGrid: function(a, b) {
                    ...
                    b.api.registerEventsFromObject(c.events), b.api.registerMethodsFromObject(c.methods), b.api.core.on.renderingComplete(a, function(c) {
                        b.api.edit.on.afterCellEdit(a, f.endEditCell), b.api.edit.on.beginCellEdit(a, f.beginEditCell),
                            b.api.edit.on.cancelCellEdit(a, f.cancelEditCell), b.api.cellNav && b.api.cellNav.on.navigate(a, f.navigate)
                    })
                },
                defaultGridOptions: function(a) {},
        ...
        a.constant("uiGridSelectionConstants", {
            ...
            return {
                ...
                link: function(a, d, e, f) {
                    ...
                    var i = f.grid;
                    a.selectButtonClick = g, "ie" === c.detectBrowser() && d.on("mousedown", h), a.$on("$destroy", function() {
                        d.off()
                    })
                }
            }
        ...
        a.constant("uiGridTreeBaseConstants", {
            ...
            var i = {
                ...
                updateRowHeaderWidth: function(a) {
                    ...
                    var e = !0;
                    a.options.showTreeRowHeader === !1 && (e = !1), a.options.treeRowHeaderAlwaysVisible === !1 && a.treeBase.numberLevels <= 0 && (e = !1), c && c.visible !== e && (c.visible = e, c.colDef.visible = e, a.queueGridRefresh())
                },
